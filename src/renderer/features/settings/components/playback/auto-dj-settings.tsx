    ...
    const itemLabels = useMemo(
        () =>
            settings.mode === 'albums'
                ? {
                      description: t('setting.autoDJ_itemCount_albums_description'),
                      title: t('setting.autoDJ_itemCount_albums'),
                  }
                : {
                      description: t('setting.autoDJ_itemCount_songs_description'),
                      title: t('setting.autoDJ_itemCount_songs'),
                  },
        [settings.mode, t],
    );
